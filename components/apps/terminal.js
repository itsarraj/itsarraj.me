...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      projects: [
        "animesh9patel-personal-portfolio",
        "synonyms-list-react",
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">animesh@Dell</div>
  ...
  handleCommands = (command, rowId) => {
    ...
    switch (main) {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/animesh");
        break;
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-animesh, todoist, trash, settings, sendmsg]";
        }
        break;
      case "echo":
      ...
      case "about-animesh":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-animesh");
        } else {
          result =
            "Command '" +
            main +
